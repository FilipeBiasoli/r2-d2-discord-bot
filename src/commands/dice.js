...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('dice')
		.setDescription('Escolha o valor máximo do dado, e jogue para ver sua sorte!')
    .addIntegerOption(option => option.setName('int').setDescription('Número máximo de dados')),
